...
public class GuiaDespachoController {
    ...
    @PostMapping("/demo")
    public ResponseEntity<GuiaDespachoResponse> crearGuiaDemo(
            @RequestParam(defaultValue = "transportistaX") String transportista) throws Exception {
        return ResponseEntity.status(HttpStatus.CREATED).body(guiaDespachoService.crearGuiaDemo(transportista));
    }
    ...
    @PutMapping("/{fecha}/{transportista}/{idGuia}/generar")
    public ResponseEntity<GuiaDespachoResponse> actualizarGuiaGenerada(@PathVariable String fecha,
            @PathVariable String transportista, @PathVariable String idGuia, @RequestBody GuiaDespachoRequest request)
            throws Exception {
        return ResponseEntity.ok(guiaDespachoService.actualizarGuiaGenerada(fecha, transportista, idGuia, request));
    }
