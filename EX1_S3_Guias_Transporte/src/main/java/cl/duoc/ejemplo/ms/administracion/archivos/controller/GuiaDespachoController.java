...
public class GuiaDespachoController {
    ...
    @PostMapping("/demo")
    public ResponseEntity<List<GuiaDespachoResponse>> crearGuiasDemo() throws Exception {
        return ResponseEntity.status(HttpStatus.CREATED).body(guiaDespachoService.crearGuiasDemo());
    }

    @GetMapping("/demo")
    public ResponseEntity<List<S3ObjectDto>> consultarHistorialDemo() {
        return ResponseEntity.ok(guiaDespachoService.consultarHistorialDemo());
    }
